...
Arhitektura koristi tri osnovne uloge (Administrator, Knowledge Curator, Knowledge Explorator) s opcionalnim mogućnostima (Knowledge Creation, Agent Access, Analytics Access, Reviewer Status) koje kuratori mogu zatražiti prema potrebi.
\end{rationale}
...
Istraživačev identitet kao kuratora je stabilan, ali njihova potreba za izravnim stvaranjem ili pristupom agentima varira s vremenom. Novi korisnik počinje s tijekom rada temeljenim na prijedlozima—uploadaju dokumente i predlažu činjenice ili čvorove grafa za pregled. Ovo lagano sudjelovanje gradi upoznatost dok održava kontrolu kvalitete. Nakon što pokažu razumijevanje i pružanje vrijednih prijedloga, mogu zatražiti mogućnost Knowledge Creation za izravno stvaranje sadržaja (još uvijek podložno pregledu ali s bržim tijekom rada). Još kasnije mogu zatražiti pristup agentima za skaliranje svog rada, ili status revizora za evaluaciju doprinosa drugih. Ova postupna progresija odražava prirodnu evoluciju tijeka rada umjesto prisiljavanja korisnika u rigidne kategorije.

Arhitektura implementira ovo kroz osnovne uloge plus opcionalne mogućnosti. Tri osnovne uloge odražavaju istinske razlike u razini pristupa platformi: Administrator (upravlja platformom), Knowledge Curator (uploada dokumente i predlaže doprinose znanju), Knowledge Explorator (čita sadržaj). Osnovni kuratori mogu uploadati dokumente i predlagati činjenice ili čvorove grafa—osnovni tijek sudjelovanja. Mogućnosti predstavljaju dodatne dozvole koje kuratori zahtijevaju prema potrebi: Knowledge Creation (izravno stvaranje činjenica/čvorova), Agent Access (pokretanje AI agenata), Analytics Access (masovni izvoz podataka), Reviewer Status (odobravanje prijedloga od drugih kuratora). Ovaj model pruža i jednostavnost (tri osnovne uloge pokrivaju sve korisnike) i fleksibilnost (mogućnosti se slobodno kombiniraju kako bi odgovarale individualnim tijekovima rada).

Ključni uvid je prepoznavanje da istraživači prirodno nose više šešira i rastu u odgovornosti. Isti biolog može započeti uploadom radova i predlaganjem činjenica (osnovna aktivnost kuratora), kasnije zaslužiti prava izravnog stvaranja za učinkovitiji rad (mogućnost Knowledge Creation), pokretati agente ekstrakcije za obradu literature na skali (Agent Access) i izvoziti agregirane podatke za analizu (Analytics Access), sve unutar jedne istraživačke sesije. Umjesto prisiljavanja da prebacuju između identiteta uloga ili da budu trajno zaključani u jednoj ulozi, model mogućnosti dopušta da njihove dozvole rastu organski s njihovim potrebama i dokazanim povjerenjem.

Tijek zahtjeva za mogućnostima ugrađuje učenje i izgradnju povjerenja u evoluciju dozvola. Novi korisnici počinju s pristupom kuratora temeljenim na prijedlozima, uče sustav i predlažu doprinose znanju. Kada pokažu razumijevanje, zahtijevaju mogućnost Knowledge Creation s primjerima svojih kvalitetnih prijedloga. Administratori pregledavaju zahtjev, razmatrajući korisničku evidenciju. Ovaj model postupnog pristupa usklađuje sigurnost (mogućnosti dodijeljene na temelju dokazanog povjerenja) s upotrebljivošću (korisnici nisu preopterećeni dozvolama koje još ne trebaju ili ne razumiju).

Ovaj pristup prihvaća da su neke mogućnosti uobičajeni koraci napretka dok su druge specijalizirane. Većina kuratora će napredovati od prijedloga do izravnog stvaranja kako pokažu kompetenciju. Mnogi će na kraju zatražiti status revizora jer je pregled prirodna evolucija doprinošenja. Manje ih će trebati pristup analitici jer masovni izvoz podataka služi specijaliziranim slučajevima uporabe. Model se prirodno prilagođava ovoj distribuciji—uobičajene mogućnosti se rutinski odobravaju na temelju dokazanog doprinosa dok neobični zahtjevi izazivaju pomnu provjeru.

\subsection{Četiri mogućnosti}

\begin{rationale}{Projektna odluka: Knowledge Creation, Agent Access, Analytics Access i Reviewer Status kao zasebno zahtjevne mogućnosti}
Ove specifične četiri mogućnosti predstavljaju smislene granice dozvola umjesto proizvoljnih podjela.
\end{rationale}

Svaka mogućnost odgovara istinitoj sigurnosnoj ili kvalitativnoj zabrinutosti koja opravdava tretiranje kao odvojiva dozvola.

\textbf{Knowledge Creation} je prva mogućnost koju većina kuratora zatraži, ipak predstavlja važnu granicu kontrole kvalitete. Osnovni kuratori podnose prijedloge—lagane prijedloge za činjenice ili čvorove grafa koji zahtijevaju odobrenje revizora prije ulaska u sustav. Ovaj tijek rada prijedloga ima nizak rizik: loši prijedlozi mogu biti brzo odbijeni bez zagađivanja baze znanja. Mogućnost Knowledge Creation dopušta kuratorima izravno stvaranje činjenica i čvorova grafa (još uvijek podložno pregledu, ali s većim prioritetom i bržim tijekom rada). Ova razlika je važna jer izravno stvaranje, čak i s pregledom, nosi veću težinu od prijedloga. Činjenica koju stvorio povjerljivi kurator pretpostavlja se veće kvalitete od anonimnog prijedloga, utječući kako revizori dodjeljuju pažnju. Mogućnost se ne dodjeljuje automatski jer kontrola kvalitete ovisi o znanju tko ima prava izravnog stvaranja.

Progresija od prijedloga do stvaranja odražava akademsko napredovanje: studenti predlažu ideje pod nadzorom prije dobivanja neovisnosti za tvrdnje. Novi kuratori uče model znanja platforme predlažući činjenice i primajući povratne informacije. Nakon što pokažu razumijevanje kroz kvalitetne prijedloge, zaslužuju prava stvaranja za učinkovitiji rad. Ovaj postupni pristup sprječava zagađenje baze znanja dok pozdravlja široko sudjelovanje.

\textbf{Agent Access} kontrolira sposobnost pokretanja AI agenata koji čine vanjske API pozive (npr. pružateljima LLM-a) i troše sistemske kvote. Agenti s lošim ponašanjem mogli bi nagomilati troškove API-ja ili degradirati performanse sustava. Ne treba svakom kuratoru ova moć—mnogi rade učinkovito ručno stvarajući unose znanja. Oni kojima trebaju agenti (za masovnu ekstrakciju iz mnogih radova) mogu zatražiti pristup s obrazloženjem koje dopušta administratorima procijeniti legitimnost zahtjeva.
...
Ove četiri mogućnosti proizašle su iz analize obrazaca dozvola i sigurnosnih zahtjeva. Ispitali smo što kuratori rade i identificirali granice dozvola sa sigurnosnim ili kvalitativnim implikacijama vrijednim zaštite. Broj je četiri jer toliko smislenih granica postoji: izravno stvaranje nasuprot prijedlogu (progresija kontrole kvalitete), operacije agenata (rizik troškova i performansi), masovni pristup podacima (rizik eksfiltracije) i kontrola kvalitete (rizik integriteta sadržaja). Svaka mogućnost adresira različitu zabrinutost koja opravdava tijek odobrenja.
...
Komponente se deployiraju nativno na host sistemu bez kontejnerizacije:

\begin{itemize}
    \item advandeb-modeling-assistant: FastAPI backend s \texttt{uvicorn}, Vue.js frontend serviran kroz nginx
    \item advandeb-knowledge-builder: Python paket instaliran kao \texttt{pip install -e .}, korišten direktno od MA backenda
    \item advandeb-MCP server: Rust binarni (\texttt{cargo build --release}), pokrenut direktno
    \item MongoDB, Redis, Ollama: instalirani lokalno putem OS package managera
\end{itemize}

Konzistentnost okoline osigurava se conda environment datotekama (\texttt{environment.yml}) i fiksiranim verzijama zavisnosti u \texttt{requirements.txt} i \texttt{Cargo.lock}.
