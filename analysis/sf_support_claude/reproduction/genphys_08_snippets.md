# Evidence snippets — genphys_08 — Reproduction abstracts (full ~3.9M unique)
...
### 1. ✅ supports (relevance 0.7) · sim ~0.74
...
### 2. ▫️ neutral (relevance 0.4) · sim ~0.73
...
### 3. ▫️ neutral (relevance 0.3) · sim ~0.72
...
### 4. ▫️ neutral (relevance 0.3) · sim ~0.72
...
### 6. ▫️ neutral (relevance 0.3) · sim ~0.71
...
### 8. ✅ supports (relevance 0.5) · sim ~0.71
...
### 9. ▫️ neutral (relevance 0.3) · sim ~0.71
...
### 11. ✅ supports (relevance 0.5) · sim ~0.71
...
### 12. ✅ supports (relevance 0.6) · sim ~0.71
...
### 13. ▫️ neutral (relevance 0.3) · sim ~0.71
*Source:* Food limitation in larval fish: ontogenetic variation in feeding scope and its potential effect on survival (2008) — DOI https://doi.org/10.3354/meps07590
...
*Source:* Form Changes in Fish Larvae in Relation To Changing Demands of Function (1989) — DOI https://doi.org/10.1163/156854289x00354
