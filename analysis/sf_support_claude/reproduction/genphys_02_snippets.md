# Evidence snippets — genphys_02 — Reproduction abstracts (full ~3.9M unique)
...
### 1. ✅ supports (relevance 0.6) · sim ~0.77
...
### 3. ❌ contradicts (relevance 0.7) · sim ~0.77
...
### 4. ❌ contradicts (relevance 0.7) · sim ~0.77
...
### 6. ❌ contradicts (relevance 0.6) · sim ~0.76
...
### 7. ▫️ neutral (relevance 0.4) · sim ~0.76
...
### 13. ❌ contradicts (relevance 0.5) · sim ~0.74
*Source:* Studies in the evolution of endothermy: mammals from reptiles (1984)
...
### 14. ▫️ neutral (relevance 0.3) · sim ~0.74
*Source:* Sizes, proportions and environment (2021) — DOI https://doi.org/10.5802/crbiol.48
