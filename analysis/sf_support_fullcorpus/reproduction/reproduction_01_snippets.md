# Evidence snippets — reproduction_01 — Reproduction abstracts (full ~3.9M unique)
...
### 1. G:▫️neutral (r0.2) · C:▫️neutral (r0.1) · sim~0.76
...
### 2. G:✅supports (r0.9) · C:✅supports (r0.8) · sim~0.76
...
### 3. G:▫️neutral (r0.1) · C:▫️neutral (r0.2) · sim~0.75
...
### 4. G:▫️neutral (r0.2) · C:▫️neutral (r0.2) · sim~0.75
...
### 5. G:▫️neutral (r0.3) · C:▫️neutral (r0.2) · sim~0.75
...
### 6. G:▫️neutral (r0.1) · C:▫️neutral (r0.2) · sim~0.74
...
### 7. G:▫️neutral (r0.2) · C:✅supports (r0.7) · sim~0.74
...
### 8. G:▫️neutral (r0.3) · C:▫️neutral (r0.2) · sim~0.74
...
### 9. G:✅supports (r0.6) · C:▫️neutral (r0.1) · sim~0.74
...
### 10. G:▫️neutral (r0.3) · C:✅supports (r0.5) · sim~0.74
...
### 11. G:✅supports (r0.5) · C:▫️neutral (r0.2) · sim~0.73
...
### 12. G:▫️neutral (r0.2) · C:✅supports (r0.6) · sim~0.73
...
### 13. G:✅supports (r0.5) · C:▫️neutral (r0.1) · sim~0.73
*Source:* WINTER RESTING STAGES OF CERTAIN ERICACEAE (1955) — DOI https://doi.org/10.1139/b55-044
...
### 14. G:❌contradicts (r0.8) · C:❌contradicts (r0.5) · sim~0.73
...
### 15. G:▫️neutral (r0.2) · C:✅supports (r0.6) · sim~0.73
*Source:* Models of reproduction, development, and growth in invertebrates (2022) — DOI https://doi.org/10.33545/26646501.2022.v4.i2a.31
...
*Source:* Comparative life histories of fishes in the subgenus <i>Limia</i> (Pisces: Poeciliidae) (2015) — DOI https://doi.org/10.1111/jfb.12695
