# Evidence snippets — chl_01 — Reproduction abstracts (full ~3.9M unique)
...
### 1. G:▫️neutral (r0.1) · C:▫️neutral (r0.1) · sim~0.74
...
### 2. G:▫️neutral (r0.1) · C:▫️neutral (r0.1) · sim~0.72
...
### 4. G:▫️neutral (r0.1) · C:▫️neutral (r0.1) · sim~0.70
...
### 5. G:▫️neutral (r0.1) · C:▫️neutral (r0.0) · sim~0.70
...
### 6. G:▫️neutral (r0.3) · C:▫️neutral (r0.3) · sim~0.70
...
### 7. G:▫️neutral (r0.1) · C:▫️neutral (r0.1) · sim~0.70
...
### 9. G:▫️neutral (r0.4) · C:▫️neutral (r0.4) · sim~0.70
...
### 10. G:▫️neutral (r0.1) · C:▫️neutral (r0.1) · sim~0.69
...
*Source:* [Effect of cultivation conditions on the age structure of a yeast population]. (1989)
...
> Here, the nutrient supply (black diamond) is inside the convex hull, implying coexistence of all species in the chemostat limit (see text). In the model, a species σ is defined by its unique enzyme strategy α→σ=(ασ,i,…,ασ,p) which determines its ability to consume different nutrients. We assume that each species can consume multiple nutrients simultaneously, in line with the behavior of microbes at low nutrient concentrations (Kovárová-Kovar and Egli, 1998), though this assumption may not hold for all microbial species. Specifically, we assume that species σ consumes nutrient i at a rate jσ,i (per unit biomass) that depends on nutrient availability ci and on its enzyme-allocation strategy ασ

### 18. G:▫️neutral (r0.1) · C:▫️neutral (r0.2) · sim~0.69
*Source:* N-limited or N and P co-limited indications in the surface waters of three Mediterranean basins (2010) — DOI https://doi.org/10.5194/bgd-7-8143-2010
