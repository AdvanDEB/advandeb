# Evidence snippets — hypoxia_07 — Reproduction abstracts (full ~3.9M unique)
...
### 1. G:▫️neutral (r0.4) · C:✅supports (r0.7) · sim~0.85
...
### 2. G:✅supports (r0.9) · C:✅supports (r0.8) · sim~0.84
...
### 3. G:✅supports (r0.6) · C:✅supports (r0.8) · sim~0.84
...
### 4. G:✅supports (r0.9) · C:✅supports (r0.9) · sim~0.84
...
### 5. G:✅supports (r0.9) · C:✅supports (r0.9) · sim~0.83
...
### 6. G:✅supports (r0.6) · C:✅supports (r0.8) · sim~0.83
...
### 7. G:▫️neutral (r0.4) · C:✅supports (r0.7) · sim~0.83
...
### 8. G:✅supports (r0.9) · C:✅supports (r0.7) · sim~0.83
...
### 9. G:✅supports (r0.8) · C:✅supports (r0.7) · sim~0.83
...
### 10. G:✅supports (r0.9) · C:✅supports (r0.9) · sim~0.83
...
### 11. G:✅supports (r0.6) · C:✅supports (r0.8) · sim~0.82
...
### 12. G:✅supports (r0.9) · C:✅supports (r0.9) · sim~0.82
