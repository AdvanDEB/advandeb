# Evidence snippets — stoichiometry_02 — Reproduction abstracts (full ~3.9M unique)
...
### 1. G:✅supports (r0.7) · C:✅supports (r0.8) · sim~0.78
...
### 2. G:▫️neutral (r0.1) · C:▫️neutral (r0.2) · sim~0.74
...
### 3. G:▫️neutral (r0.2) · C:▫️neutral (r0.3) · sim~0.73
...
### 4. G:▫️neutral (r0.1) · C:▫️neutral (r0.2) · sim~0.73
...
### 5. G:▫️neutral (r0.2) · C:▫️neutral (r0.2) · sim~0.73
...
### 6. G:▫️neutral (r0.1) · C:▫️neutral (r0.1) · sim~0.73
...
### 7. G:▫️neutral (r0.2) · C:▫️neutral (r0.3) · sim~0.73
...
### 8. G:▫️neutral (r0.3) · C:❌contradicts (r0.6) · sim~0.72
...
### 9. G:▫️neutral (r0.1) · C:▫️neutral (r0.2) · sim~0.72
...
### 10. G:✅supports (r0.5) · C:✅supports (r0.8) · sim~0.72
...
### 11. G:▫️neutral (r0.1) · C:▫️neutral (r0.3) · sim~0.72
...
### 12. G:✅supports (r0.6) · C:✅supports (r0.7) · sim~0.72
...
### 13. G:▫️neutral (r0.1) · C:▫️neutral (r0.2) · sim~0.72
...
### 14. G:▫️neutral (r0.3) · C:❌contradicts (r0.6) · sim~0.72
*Source:* Herbivore consumers face different challenges along opposite sides of the stoichiometric knife‐edge (2019) — DOI https://doi.org/10.1111/ele.13386

> Abstract Anthropogenic activities have reshaped the relative supply rates of essential elements to organisms. Recent studies suggested that consumer performance is strongly reduced by food that is either very high or very low in relative phosphorus content. However, the generality of such ‘stoichiometric knife‐edge’ and its underlying mechanisms are poorly understood. We studied the response of a planktonic rotifer to a 10‐fold food carbon : phosphorus (C : P) gradient and confirmed the existence of the stoichiometric knife‐edge. Interestingly, we observed a complete homeostatic breakdown associated with strong growth reductions at high food C : P. In contrast, at low food C : P, animals mai

### 15. G:✅supports (r0.4) · C:✅supports (r0.6) · sim~0.72
*Source:* The Feeding of <i>Amoeba proteus</i> on <i>Paramecium aurelia</i>* (1968) — DOI https://doi.org/10.1111/j.1550-7408.1968.tb02122.x
...
### 16. G:▫️neutral (r0.1) · C:▫️neutral (r0.3) · sim~0.72
*Source:* Conditioning of the membrane fatty acid profile of Escherichia coli during periodic temperature cycling (2009) — DOI https://doi.org/10.1099/mic.0.029637-0
...
### 17. G:▫️neutral (r0.2) · C:▫️neutral (r0.2) · sim~0.72
*Source:* Some effects of patchy food environments on copepods1 (1977) — DOI https://doi.org/10.4319/lo.1977.22.1.0099
