# Evidence snippets — genphys_07 — Reproduction abstracts (full ~3.9M unique)
...
### 1. G:❌contradicts (r0.9) · C:❌contradicts (r0.9) · sim~0.86
...
### 2. G:❌contradicts (r0.8) · C:❌contradicts (r0.8) · sim~0.86
...
### 3. G:▫️neutral (r0.6) · C:✅supports (r0.8) · sim~0.84
...
### 4. G:▫️neutral (r0.5) · C:▫️neutral (r0.7) · sim~0.83
...
### 5. G:▫️neutral (r0.6) · C:✅supports (r0.8) · sim~0.83
...
### 6. G:✅supports (r0.9) · C:✅supports (r0.7) · sim~0.82
...
### 7. G:▫️neutral (r0.5) · C:✅supports (r0.8) · sim~0.82
...
### 8. G:✅supports (r0.7) · C:✅supports (r0.6) · sim~0.82
...
### 9. G:✅supports (r0.8) · C:✅supports (r0.8) · sim~0.82
...
### 10. G:❌contradicts (r0.8) · C:❌contradicts (r0.8) · sim~0.82
...
### 11. G:▫️neutral (r0.5) · C:✅supports (r0.7) · sim~0.82
...
### 12. G:✅supports (r0.8) · C:✅supports (r0.7) · sim~0.82
